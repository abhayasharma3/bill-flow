    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-grid pt-16">
        ...
        <div className="container relative z-10 flex flex-col items-center text-center gap-8 py-20">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="mt-8 w-full max-w-4xl rounded-xl border border-border bg-card p-1 glow-green">
            <div className="rounded-lg bg-secondary/50 p-6">
              ...
              <div className="space-y-3">
                {["Electric Bill", "Internet", "Insurance"].map((name, i) => (
                  <div key={name} className="flex items-center justify-between rounded-lg border border-border bg-card px-4 py-3">
                    <span className="text-sm text-foreground">{name}</span>
                    <span className={`text-xs rounded-full px-2 py-0.5 ${i < 2 ? "bg-primary/10 text-primary" : "bg-secondary text-muted-foreground"}`}>
                      {i < 2 ? "Paid" : "Upcoming"}
                    </span>
                  </div>
                ))}
        ...
        <div className="container relative z-10">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <motion.div key={f.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="group rounded-xl border border-border bg-card p-6 transition-all hover:border-primary/30 hover:glow-green">
